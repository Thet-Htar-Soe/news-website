        ...
        <Container fluid>
            ...
            <Row className="mx-3 pt-2">
                <Col lg={6} md={6} sm={12}>
                    ...
                    <p className="w-75 text-justify d-inline-block">Globetrotting. This is a word used to describe someone who's going on a long journey around the world, and a globetrotter is someone who travels a lot, and all over the world, especially for sightseeing.</p>
                </Col>
                <Col lg={6} md={6} sm={12}>
